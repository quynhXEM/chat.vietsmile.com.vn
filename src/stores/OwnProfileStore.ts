...
export class OwnProfileStore extends AsyncStoreWithClient<IState> {
    ...
    protected async onReady(): Promise<void> {
        ...
        // are fired only with presence, which e2chat.com (and many others) has disabled.
        ...
        async (): Promise<void> => {
            ...
            try {
                ...
                if (!(error instanceof MatrixError) || error.errcode !== "M_NOT_FOUND") {
                     ...
                     * {@link https://spec.e2chat.com/v1.7/client-server-api/#get_matrixclientv3profileuserid}
