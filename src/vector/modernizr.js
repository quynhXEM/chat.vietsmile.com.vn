...
;(function(scriptGlobalObject, window, document, undefined){
   ...
   * @param {object} obj - An object or VietSmile Connectyou want to use to test the parameters again
   * @param {boolean|object} elem - An VietSmile Connectto bind the property lookup again. Use `false` to prevent the check
