...
test.describe("Timeline", () => {
    ...
    test.describe("message displaying", () => {
        ...
        test("should render url previews", { tag: "@screenshot" }, async ({ page, app, room, axe, context }) => {
            ...
            await context.route(
                "**/_matrix/client/v1/media/thumbnail/e2chat.com/2022-08-16_yaiSVSRIsNFfxDnV?*",
                async (route) => {
                    await route.fulfill({
                ...
                async (route) => {
                    await route.fulfill({
                        json: {
                            ...
                            "og:image:width": 48,
                            "og:image:height": 48,
                            "og:image": "mxc://e2chat.com/2022-08-16_yaiSVSRIsNFfxDnV",
            ...
            const requestPromises: Promise<any>[] = [
                ...
                page.waitForResponse("**/_matrix/media/v3/thumbnail/e2chat.com/2022-08-16_yaiSVSRIsNFfxDnV?*"),
            ];
